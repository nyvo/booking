...
import { useClass, useClassMutations } from "@/hooks/useClasses";
...
export default function ClassEdit() {
  ...
  const { update, remove, loading, error } = useClassMutations();
  ...
  useEffect(() => {
    if (classData) {
      form.reset({
        ...
        dropInAvailable: classData.dropInAvailable,
    ...
    return (
      <TeacherLayout>
        <div className="space-y-6">
          ...
          <Button onClick={() => navigate(ROUTES.TEACHER.CLASSES)}>
            Tilbake til timer
          </Button>
        </div>
      </TeacherLayout>
              ...
              {classData.bookedCount > 0 && (
                <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                  <p className="text-sm text-blue-800">
                    <strong>Info:</strong> {classData.bookedCount}{" "}
                    {classData.bookedCount === 1 ? "påmeldt" : "påmeldte"} på
                    denne timen. Endringer i pris, dato eller tid blir
        ...
        <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Er du sikker på at du vil slette denne timen? Dette kan ikke
                angres.
                {classData.bookedCount > 0 && (
                  <span className="block mt-2 font-medium text-red-600">
                    Advarsel: {classData.bookedCount} påmeldte på denne timen!
                  </span>
                )}
              </DialogDescription>
            </DialogHeader>
