/**
 * Teacher classes management page
 */
...
export default function TeacherClasses() {
  ...
  const { data, loading, error } = useClasses(classFilters, classPagination);
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-semibold text-foreground">
              {t("teacher.class.title")}
            </h1>
            <p className="mt-2 text-muted-foreground">
              Administrer dine yogatimer
            </p>
          </div>
          <button
            onClick={() => navigate(ROUTES.TEACHER.CLASSES_CREATE)}
            className="rounded-lg bg-primary px-4 py-2 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90"
          >
            {t("teacher.class.createClass")}
          </button>
        </div>
        ...
        {error && (
          <div className="rounded-lg border border-red-200 bg-red-50 p-4 text-red-800">
            <p className="font-medium">Kunne ikke laste timer</p>
                  ...
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex flex-col items-end gap-3">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          navigate(
                            ROUTES.TEACHER.CLASSES_EDIT.replace(
                              ":id",
                              classItem.id,
                            ),
                          )
